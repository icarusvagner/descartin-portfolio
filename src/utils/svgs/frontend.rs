...
#[component]
pub fn TypeScript(#[prop(into, optional)] class: MaybeProp<String>) -> AnyView {
	view! {
		<svg
			role="img"
			class=move || {
...
#[component]
pub fn JavaScript(#[prop(into, optional)] class: MaybeProp<String>) -> AnyView {
	view! {
		<svg
			role="img"
			class=move || {
...
#[component]
pub fn LeptosIcon(#[prop(into, optional)] class: MaybeProp<String>) -> AnyView {
	view! {
		<svg
			role="img"
			class=move || {
...
#[component]
pub fn Svelte(#[prop(into, optional)] class: MaybeProp<String>) -> AnyView {
	view! {
		<svg
			role="img"
			class=move || {
...
#[component]
pub fn VueJS(#[prop(into, optional)] class: MaybeProp<String>) -> AnyView {
	view! {
		<svg
			role="img"
			class=move || {
...
#[component]
pub fn Html5(#[prop(into, optional)] class: MaybeProp<String>) -> AnyView {
	view! {
		<svg
			role="img"
			class=move || {
...
#[component]
pub fn Htmx(#[prop(into, optional)] class: MaybeProp<String>) -> AnyView {
	view! {
		<svg
			role="img"
			class=move || {
...
#[component]
pub fn Css3(#[prop(into, optional)] class: MaybeProp<String>) -> AnyView {
	view! {
		<svg
			role="img"
			class=move || {
...
#[component]
pub fn TailwindCSS(#[prop(into, optional)] class: MaybeProp<String>) -> AnyView {
	view! {
		<svg
			role="img"
			class=move || {
...
#[component]
pub fn GraphQL(#[prop(into, optional)] class: MaybeProp<String>) -> AnyView {
	view! {
		<svg
			role="img"
			class=move || {

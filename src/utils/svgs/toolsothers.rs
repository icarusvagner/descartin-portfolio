...
#[component]
pub fn LinuxTux(#[prop(into, optional)] class: MaybeProp<String>) -> impl IntoView {
	view! {
          <svg
                role="img"
                class=move || {
                      format!("text-[#FCC624] {}", class.get().unwrap_or("h-12 w-12".to_string()))
                }
                viewBox="0 0 24 24"
...
#[component]
pub fn Git(#[prop(into, optional)] class: MaybeProp<String>) -> impl IntoView {
	view! {
          <svg
                role="img"
                class=move || {
                      format!("text-[#F05032] {}", class.get().unwrap_or("h-12 w-12".to_string()))
                }
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
...
#[component]
pub fn GitHub(#[prop(into, optional)] class: MaybeProp<String>) -> impl IntoView {
	view! {
          <svg
                role="img"
                class=move || class.get().unwrap_or("h-12 w-12".to_string())
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
          >
...
#[component]
pub fn Supabase(#[prop(into, optional)] class: MaybeProp<String>) -> impl IntoView {
	view! {
          <svg
                role="img"
                class=move || {
                      format!("text-[#3FCF8E] {}", class.get().unwrap_or("h-12 w-12".to_string()))
                }
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
...
#[component]
pub fn CiCd(#[prop(into, optional)] class: MaybeProp<String>) -> impl IntoView {
	view! {
          <svg
                class=move || class.get().unwrap_or("h-12 w-12".to_string())
                fill="currentColor"
...
#[component]
pub fn Agile(#[prop(into, optional)] class: MaybeProp<String>) -> impl IntoView {
	view! {
          <svg
                viewBox="0 0 32 32"
                version="1.1"
...
#[component]
pub fn GithubActions(#[prop(into, optional)] class: MaybeProp<String>) -> impl IntoView {
	view! {
          <svg
                role="img"
                class=move || {
                      format!("text-[#2088FF] {}", class.get().unwrap_or("h-12 w-12".to_string()))
                }
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
...
#[component]
pub fn FigmaDesign(#[prop(into, optional)] class: MaybeProp<String>) -> impl IntoView {
	view! {
          <svg
                role="img"
                class=move || {
                      format!("text-[#F24E1E] {}", class.get().unwrap_or("h-12 w-12".to_string()))
                }
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
...
#[component]
pub fn Python(#[prop(into, optional)] class: MaybeProp<String>) -> impl IntoView {
	view! {
          <svg
                role="img"
                class=move || {
                      format!("text-[#3776AB] {}", class.get().unwrap_or("h-12 w-12".to_string()))
                }
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
...
#[component]
pub fn Nginx(#[prop(into, optional)] class: MaybeProp<String>) -> impl IntoView {
	view! {
          <svg
                role="img"
                class=move || {
                      format!("text-[#009639] {}", class.get().unwrap_or("h-12 w-12".to_string()))
                }
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
...
#[component]
pub fn Jest(#[prop(into, optional)] class: MaybeProp<String>) -> impl IntoView {
	view! {
          <svg
                role="img"
                class=move || {
                      format!("text-[#C21325] {}", class.get().unwrap_or("h-12 w-12".to_string()))
                }
                fill="none"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
...
#[component]
pub fn Tauri(#[prop(into, optional)] class: MaybeProp<String>) -> impl IntoView {
	view! {
          <svg
                role="img"
                class=move || {
                      format!("text-[#24C8D8] {}", class.get().unwrap_or("h-12 w-12".to_string()))
                }
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"

    ...
    view! {
        <section class="flex flex-col items-center gap-8 bg-neutral-100 dark:bg-neutral-900 py-32">
            <A href="#top" attr:class="group relative inline-flex">
                ...
                <p class="absolute top-1/2 right-0 -translate-x-1/2 text-2xl font-black tracking-tight text-neutral-800 group-hover:-right-12 duration-300 transition-all ease-initial dark:text-neutral-200 group-hover:scale-100 scale-0 font-oswald">
                    "Top"
                </p>
            </A>

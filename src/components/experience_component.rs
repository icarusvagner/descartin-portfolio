...
pub fn ExperienceComponent() -> impl IntoView {
	...
	let exp_3 = ["Developing CPC Library System to cater the needs of students, faculty, and librarian".to_string(),
...
fn ExperienceCard(
	...
	#[prop(into)] job_desc: Vec<String>,
	#[prop(into)] tech_stack: Vec<String>,
) -> impl IntoView {
	view! {
	    <div class="flex flex-col gap-4 md:flex-row">
		  ...
		  <div class="md:w-2/3">
			...
			<ul class="ml-5 space-y-2 list-disc list-outside text-base-content/70">
			    <For
				  each=move || job_desc.clone()
				  key=|job_desc| job_desc.clone()
				  let:child
			    >
				  <li>{child}</li>
			    </For>

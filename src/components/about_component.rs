					...
					<div>
						...
						<ul class="space-y-3">
							<li class="flex gap-3 items-center">
								<Icon icon=ENVELOPE_SIMPLE attr:class="text-primary h-8 w-8" />
							...
							<li class="flex gap-3 items-center">
								<Icon icon=CALENDAR_DOTS attr:class="text-primary h-8 w-8" />
								<span>"3+ Years Experience"</span>
							</li>
							<li class="flex gap-3 items-center">
								<Icon icon=GRADUATION_CAP attr:class="text-primary h-8 w-8" />
								<span>"B.S Information Technology, Cordova Public College"</span>
							</li>
						</ul>
						<div class="flex gap-4 mt-6">
							<A href="https://github.com/icarusvagner" attr:class="cursor-pointer">
								<LeptosIcon
